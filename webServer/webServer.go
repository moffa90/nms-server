...
import (
	...
	"github.com/moffa90/nms-server/webServer/configuration"
	"github.com/moffa90/nms-server/webServer/hardware"
	"github.com/moffa90/nms-server/webServer/home"
	"github.com/moffa90/nms-server/webServer/information"
	"github.com/moffa90/nms-server/webServer/login"
	"github.com/moffa90/nms-server/webServer/logout"
	"github.com/moffa90/nms-server/webServer/networks/ethernet"
	"github.com/moffa90/nms-server/webServer/remotes"
	"github.com/moffa90/nms-server/webServer/snmp"
	"github.com/moffa90/nms-server/webServer/users"
	"html/template"
	"net/http"
	"os"
	"os/signal"
